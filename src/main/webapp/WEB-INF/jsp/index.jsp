...
<![endif]-->
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/h-ui/lib/Hui-iconfont/1.0.8/iconfont.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/h-ui/skin/green/skin.css" id="skin" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/h-ui/css/style.css" />
		<!--[if IE 6]>
<script type="text/javascript" src="lib/DD_belatedPNG_0.0.8a-min.js" ></script>
<script>DD_belatedPNG.fix('*');</script>
<![endif]-->
		<title>新开普客服业务后台管理系统</title>
	</head>
	...
	<body>
		<header class="navbar-wrapper">
			<div class="navbar navbar-fixed-top">
				<div class="container-fluid cl">
					<a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">新开普客服业务后台管理系统</a>
					<a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">后台管理</a>
					...
					<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
						<ul class="cl">
							<li>欢迎您,</li>
							<li class="dropDown dropDown_hover">
								<a href="#" class="dropDown_A">【<shiro:principal property="nickname"/>】<i class="Hui-iconfont">&#xe6d5;</i></a>
								<ul class="dropDown-menu menu radius box-shadow">
									<li>
		...
		<dl id="menu-member">
			...
			<dd>
				...
				<dl id="menu-admin">
					...
					<dd>
						<ul>
							<li>
								<a data-href="${pageContext.request.contextPath}/admin/user/list" data-title="用户管理" href="javascript:void(0)">用户管理</a>
							</li>
							<li>
								<a data-href="${pageContext.request.contextPath}/admin/role/list" data-title="角色管理" href="javascript:void(0)">角色管理</a>
							</li>
							<li>
								<a data-href="${pageContext.request.contextPath}/admin/resource/list" data-title="权限管理" href="javascript:void(0)">权限管理</a>
							</li>
						</ul>
					</dd>
				</dl>
			...
			<div class="menu_dropdown bk_2" style="display:none">
				<dl id="menu-control">
					...
					</i> 监控管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a data-href="http://192.168.40.233:8082/csw.html" data-title="客服中心数据监控" href="javascript:void(0)">客服中心数据监控</a>
							</li>
							<li>
								<a data-href="http://192.168.40.233:8082/csw.html" data-title="重点客户运维管理" href="javascript:void(0)">重点客户运维管理</a>
							</li>
						</ul>
					</dd>
				</dl>
			...
			<div class="menu_dropdown bk_2" style="display:none">
				<dl id="menu-analyse">
					<dt><i class="Hui-iconfont">&#xe62e;</i> 分析管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a data-href="http://192.168.40.233:8082/csw.html" data-title="客服中心数据监控" href="javascript:void(0)">客服中心数据监控</a>
			...
			<div class="menu_dropdown bk_2" style="display:none">
				<dl id="menu-decision-making">
					<dt><i class="Hui-iconfont">&#xe62e;</i> 决策管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
					<dd>
						<ul>
							<li>
								<a data-href="http://192.168.40.233:8082/csw.html" data-title="客服中心数据监控" href="javascript:void(0)">客服中心数据监控</a>
		...
		<section class="Hui-article-box">
			...
			<div id="iframe_box" class="Hui-article">
				<div class="show_iframe">
					...
					<iframe scrolling="yes" frameborder="0" src="${pageContext.request.contextPath}/admin/pagejump/welcome"></iframe>
				</div>
			</div>
		</section>
		...
		<!--_footer 作为公共模版分离出去-->
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/h-ui/lib/jquery/1.9.1/jquery.min.js"></script>
		...
		<!--请在下方写此页面业务相关的脚本-->
		<script type="text/javascript" src="${pageContext.request.contextPath}/resources/h-ui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
